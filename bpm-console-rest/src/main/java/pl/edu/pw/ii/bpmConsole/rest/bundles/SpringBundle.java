...
import pl.edu.pw.ii.bpmConsole.rest.configuration.BpmConsoleSpringConfiguration;
...
public class SpringBundle implements ConfiguredBundle<BpmConsoleConfiguration> {
    ...
    private void initializeParentContext(BpmConsoleConfiguration configuration) {
    ...
    private void initializeContext(BpmConsoleConfiguration configuration) {
        springContext = new AnnotationConfigWebApplicationContext();
        springContext.setParent(parentSpringContext);
        springContext.register(BpmConsoleSpringConfiguration.class);
